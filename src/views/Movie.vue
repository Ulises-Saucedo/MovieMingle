...
<template>
    <main class="w-full h-screen justify-center items-center">
        <div class="flex flex-col md:flex-row max-h-[700px] max-w-[800px] p-4 mx-auto">
            ...
            <section class="flex flex-col ml-2 justify-between w-full md:w-1/2">
                <section>
                    ...
                    <div class="mt-2 flex gap-2">
                        <div v-for="genre in movie.genres" class="inline p-1 rounded-sm bg-red-500">{{ genre.name }}</div>
                    </div>
                </section>
                <section>
                    <div>
                    ...
                    <div class="w-full p-1 rounded bg-red-500">
